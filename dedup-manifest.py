...
Defaults: input=modpack/server-manifest.json  output=the same file (in place)
...
def main() -> int:
    manifest_path = sys.argv[1] if len(sys.argv) > 1 else os.path.join(HERE, "modpack", "server-manifest.json")
